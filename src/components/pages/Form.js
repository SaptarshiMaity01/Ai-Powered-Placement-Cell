...
const FormComponent = ({ className = "" }) => {
  return (
    <div
      className={`flex-1 shadow-[0px_3px_11px_rgba(0,_0,_0,_0.06),_0px_10px_15px_rgba(0,_0,_0,_0.03)] rounded-xl bg-base-white flex flex-row items-start justify-start pt-10 pb-[33.2px] pl-10 pr-[38px] box-border gap-[22px] max-w-full text-center text-base text-gray-600 font-regular-13 mq750:pt-[26px] mq750:pb-[22px] mq750:box-border ${className}`}
    >
