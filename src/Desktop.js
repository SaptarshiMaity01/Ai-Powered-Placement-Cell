        ...
        <Route
          ...
          element={
            <>
              ...
              <section className="self-stretch flex flex-row items-start justify-start pt-0 pb-[60px] pl-12 pr-[50px] box-border max-w-full lg:pb-[83px] lg:box-border mq450:pb-[35px] mq450:box-border mq750:pl-6 mq750:pr-[25px] mq750:box-border mq1050:pb-[54px] mq1050:box-border">
